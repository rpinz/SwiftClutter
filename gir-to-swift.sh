...
gir2swift -o Sources -m ${Module}.module -p ${GIR_DIR}/GLib-2.0.gir -p ${GIR_DIR}/GObject-2.0.gir -p ${GIR_DIR}/cairo-1.0.gir -p ${GIR_DIR}/Pango-1.0.gir -p ${GIR_DIR}/Cogl-1.0.gir -p ${GIR_DIR}/CoglPango-1.0.gir "${GIR}"
